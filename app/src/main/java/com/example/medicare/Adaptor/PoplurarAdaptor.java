...
import com.example.medicare.Activity.ShowDetailActivity;
...
public class PoplurarAdaptor extends RecyclerView.Adapter<PoplurarAdaptor.ViewHolder> {
    ArrayList<MedicareDomain> popularFood;

    public PoplurarAdaptor(ArrayList<MedicareDomain> popularFood) {
