...
public class TinyDB {
    ...
    public ArrayList<MedicareDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MedicareDomain> playerList =  new ArrayList<MedicareDomain>();

        for(String jObjString : objStrings){
            MedicareDomain player  = gson.fromJson(jObjString,  MedicareDomain.class);
    ...
    public void putListObject(String key, ArrayList<MedicareDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(MedicareDomain player: playerList){
